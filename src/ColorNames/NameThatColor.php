...
#TODO
/**
 * implementeaza metoda din iColorName
 * transcrie init, rgb, hsl si name din
 */

class NameThatColor implements iColorName
{
    private $colorNames;
    private $color;
    ...
    private function setColorNames()
    {
    ...
    {
        $this->setColorNames();
        if (!is_null($color)) $this->setColor($color);
    }
