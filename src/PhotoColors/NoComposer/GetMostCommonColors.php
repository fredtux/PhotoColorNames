...
class GetMostCommonColors
{
    ...
    public function getColor(PhotoColorExtractorOptions $photoColorExtractorOptions)
    {
        ...
        if (is_readable($img)) {
            ...
            throw new \Exception('Image ' . $img . ' does not exist or is unreadable');
        }
    }
     ...
     * @return string
     */
    protected function _normalize($hex, $hexarray, $delta)
    {
        $lowest = 255;
        $highest = 0;
     ...
     * @return mixed
     */
    protected function _find_adjacent($hex, $gradients, $delta)
    {
